...
algoritmo problemasCompuestosCiclos16
	...
	contador <- 1 ;
	dias <- 0;
	Para indiceAnio <- 1 Hasta 99 Con Paso 1 Hacer
		Si indiceAnio MOD 4 == 0 Entonces
			anioBisiesto <- Verdadero;
		FinSi
		Para indiceMes <- 1 Hasta 12 Con Paso  1 Hacer
			...
			SiNo
				...
				FinSi
			FinSi
			Para indiceDia <- 1 Hasta dias Con Paso  1 Hacer
