...
///se le hará? un descuento del 30% sobre la colegiatura y no se le cobrara IVA; si el promedio obtenido es menor que 9 deberá? 
///pagar la colegiatura completa, la cual incluye el 10% de IVA. Obtener cuanto debe pagar un alumno

Algoritmo SelectivoSimple15 
