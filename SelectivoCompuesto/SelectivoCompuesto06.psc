...
///hará descuento alguno, si es verde se le hará un 10% de descuento, si es amarilla 
///un 25%, si es azul un 50% y si es roja un 100%. Determinar la cantidad final que 
///el cliente deberá pagar por su compra. se sabe que solo hay bolitas de los colores 
///mencionados. 

Algoritmo SelectivoCompuesto6
