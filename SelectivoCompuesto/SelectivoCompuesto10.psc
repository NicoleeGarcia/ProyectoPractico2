...
///Descripcion:Un proveedor de estéreos ofrece un descuento del 10% sobre el precio 
///sin IVA, de algún aparato si este cuesta $2000 o mas.  Además, independientemente 
///de esto, ofrece un 5% de descuento si la marca es "NOSY". Determinar cuanto pagara, 
///con IVA incluido, un cliente cualquiera por la compra de su aparato.  

Algoritmo SelectivoCompuesto10
