...
///Computadores son menos de cinco se les dará un 10% de descuento sobre el total 
///de la compra; si el número de Computadores es mayor o igual a cinco pero menos 
///de diez se le otorga un 20% de descuento; y si son 10 o más se les da un 40% 
///de descuento. El precio de cada Computador es de $11,000. 

Algoritmo SelectivoCompuesto7
