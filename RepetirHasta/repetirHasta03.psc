...
Algoritmo repetirHasta3
	...
	Escribir "        LA EDAD QUE TENGA LA EPRSONA QUE VA A INGRESAR ";
	Escribir "";
	Escribir  "            SEA USTED BIENBENIDO AL TEATRO NACIONAL";
	...
	Escribir "Por un total de ", contador - 1, " boletos vendidos el dia de hoy";
